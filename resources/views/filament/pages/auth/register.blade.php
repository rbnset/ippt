...
<div class="ippt-auth-page">
  ...
  <header class="ippt-site-nav">
    <div class="ippt-nav-inner">
      ...
      <div class="ippt-nav-actions">
        ...
        <a href="{{ route('filament.admin.auth.login') }}" class="ippt-nav-login ">Masuk</a>
        <a href="{{ route('filament.admin.auth.register') }}" class="ippt-nav-register ippt-nav-current">Daftar</a>
      </div>
    </div>
  </header>
  ...
  <main class="ippt-auth-main">
    <div class="ippt-auth-shell">
      <section class="ippt-auth-copy" aria-label="Informasi pendaftaran">
        <div class="ippt-auth-kicker"><i></i> Pendaftaran pemohon</div>
        <h1>Mulai layanan IPPT dengan <em>akun Anda.</em></h1>
        <p>Buat akun pemohon untuk memulai layanan. Setelah masuk, lengkapi data pemohon dan tunggu verifikasi petugas sebelum pengajuan IPPT tersedia.</p>
        <div class="ippt-auth-points"><div class="ippt-auth-point"><b>01</b><span><strong>Buat akun</strong><br>Gunakan email aktif yang dapat Anda akses.</span></div>
          <div class="ippt-auth-point"><b>02</b><span><strong>Lengkapi data pemohon</strong><br>Isi identitas dan alamat dengan benar.</span></div>
          <div class="ippt-auth-point"><b>03</b><span><strong>Verifikasi petugas</strong><br>Pengajuan tersedia setelah data dinyatakan terverifikasi.</span></div></div>
      </section>
      <section class="ippt-auth-card" aria-label="Form pendaftaran">
        <div class="ippt-auth-card-head"><h2>Daftar akun pemohon</h2><p>Isi data akun dengan benar untuk melanjutkan.</p></div>
        {{ $this->content }}
        <div class="ippt-auth-links">Sudah memiliki akun? <a href="{{ filament()->getLoginUrl() }}">Masuk ke sistem</a></div>
